...
export async function updateResourceStatus(id: number, status: ResourceStatus): Promise<AirportResource> {
  if (useMocksFor('ms3')) { await delay(400); return updateMockResource(id, status) }
